...
- `app.py` has no authentication. `cloud_app.py` uses a shared admin password for edits/scans; separately restrict platform access for all viewers. This is not SSO, MFA, individual attribution or enterprise brute-force protection.
